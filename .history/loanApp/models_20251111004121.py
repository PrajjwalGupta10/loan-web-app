...
loanRequest.objects.filter(request_date__isnull=True).update(request_date=date.today())
...
class loanRequest(models.Model):
    ...
    request_date = models.DateField(auto_now_add=True)    # loan_years = models.IntegerField(choices=TENURE_CHOICES, blank=True, null=True)
