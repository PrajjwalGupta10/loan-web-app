...
urlpatterns = [
    ...
    path('view-documents/<int:id>/', 
         views.view_documents, name='view_documents'),    
    ...
    path('approved-loan',  views.approved_loan, name='approved_loan'),    path('rejected-loan', views.rejected_loan, name='rejected_loan'),
